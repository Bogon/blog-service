...
type GetTagListReply struct {
	...
	Paper *Pager `protobuf:"bytes,2,opt,name=paper,proto3" json:"paper,omitempty"`
}
...
func (x *GetTagListReply) GetPaper() *Pager {
	if x != nil {
		return x.Paper
	}
	return nil
...
var file_proto_tag_proto_rawDesc = []byte{
	...
	0x22, 0x0a, 0x05, 0x70, 0x61, 0x70, 0x65, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0c,
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x50, 0x61, 0x67, 0x65, 0x72, 0x52, 0x05, 0x70, 0x61,
	0x70, 0x65, 0x72, 0x32, 0x4e, 0x0a, 0x0a, 0x54, 0x61, 0x67, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
...
var file_proto_tag_proto_depIdxs = []int32{
	...
	3, // 1: proto.GetTagListReply.paper:type_name -> proto.Pager
